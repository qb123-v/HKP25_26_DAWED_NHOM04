...
.news-container {
    ...
    margin: 0 auto;
    padding: 50px 40px;
    background-color: transparent; /* trong suốt, liền nền tổng thể */
}
...
.article-content {
    ...
    line-height: 1.8;
    color: #fff;
    background-color: rgba(255,255,255,0.05); /* hơi mờ */
    padding: 25px;
    border-radius: 0;
    box-shadow: none;
    margin-bottom: 30px;
...
<div class="news-container">
    ...
    <!-- Main Image -->
    <div class="mb-3">
        <img src="{{ asset('images/articles/' . $article->thumbnail) }}" 
                ...
                <div class="col">
                    <a href="{{ route('articles.show', [$related->id, $related->slug]) }}" class="text-decoration-none">
                        <div class="related-card">
                            <img src="{{ asset('images/articles/' . $related->thumbnail) }}" alt="{{ $related->title }}">
                            <h6>{{ $related->title }}</h6>
